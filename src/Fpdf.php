...
class FPDF
{
    ...
    var $encrypted = true;  //whether document is protected
    var $Uvalue;             //U entry in pdf document
    var $Ovalue;             //O entry in pdf document
    var $Pvalue;             //P entry in pdf document
    var $enc_obj_id;         //encryption object id

    public function setDatos( $var ){ $this->datos = $var; }
    public function setDatosAnt( $var ){ $this->datosAnt = $var; }
    public function getDatos( ){ return  $this->datos; }
    public function getPage( ){ return  $this->page; }
    public function getDatosAnt( ){ return  $this->datosAnt; }
    public function setOrientation($orientacion){ $this->DefOrientation=$orientacion; }
    public function getOrientation(){ return $this->DefOrientation; }
    public function setYearReporte($year){ $this->yearReporte = intval($year); }
    public function getYearReporte(){ return $this->yearReporte; }
    ...
    *******************************************************************************/
    ...
    function AddFont($family, $style='', $file='',$path='')
    {
    ...
    {
        // guarda las posiciones x y actuales
        $x = $this->GetX() + $w;
        $y = $this->GetY();
        // usamos MultiCell
        $this->MultiCell($w,$h,$text,$border,$align,$fill);
        // Aquí no pasó nada... con x y
        if( $ln==0 ) {
            $this->SetXY( $x, $y );
        }
    ...
    *******************************************************************************/
    ...
    protected function _loadfont($font,$path= '')
    {
